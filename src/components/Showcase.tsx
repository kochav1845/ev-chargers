  ...
  const showcaseItems = [
    {
      ...
      description: "Our advanced eGauge integration continuously monitors your building's electrical load in real-time, automatically adjusting EV charging rates to prevent circuit overloads and ensure safe operation of all your critical systems.",
